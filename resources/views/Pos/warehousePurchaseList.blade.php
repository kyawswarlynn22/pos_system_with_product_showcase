...
@section('body')
    ...
    <div class=" pt-10 pl-5 font-medium">Warehouse Product Purchase List(Recived)</div>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-5">
        ...
        <div class=" pt-10 pl-5 font-medium">Warehouse Product Purchase List(Pending)</div>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-5">
        <div class="pb-4 bg-white dark:bg-gray-900">
            <label for="table-search" class="sr-only">Search</label>
            <div class="relative mt-1">
        ...
        <div class="pt-10 font-medium">Warehouse Purchase List(Recived)</div>
                ...
                @forelse ($purchaseList as $item)
                    <tr
                        ...
                        <td class="px-6 py-4 flex justify-center space-x-2 ">
                            <a href="/warehousepurchase/{{ $item->id }}">
                            ...
                            @if ($userRole == 0)
                                <a href="/warehousepurchase/{{ $item->id }}/edit"
    ...
    <div class="pt-10 font-medium">Warehouse Purchase List(Pending)</div>
