...
@section('body')
    <p class=" text-2xl">Sale Return List</p>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-5">
        ...
        <table class="w-full text-sm text-left text-gray-500 rounded-lg dark:text-gray-400">
            ...
            <tbody>
                @forelse ($SaleReturnList as $item)
                    <tr
                        ...
                        <td class="px-6 py-4 flex justify-center space-x-2 ">
                            ...
                            <a href="/salereturn/{{ $item->id }}/edit"
                            ...
                            @endphp
                            <form action="/salereturn/{{ $item->id }}" method="post">
                                @csrf
                                @method('DELETE')
        ...
        {{ $SaleReturnList->links('pagination::tailwind') }}
    </div>
