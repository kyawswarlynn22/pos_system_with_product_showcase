...
@section('body')
    <p class=" text-2xl">Add warehouse usage and damage products</p>

    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-5">
        <span class=" text-xl ">Add Usage</span>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-5">
        <span class=" text-xl ">Add Damage</span>
        <form action="/damageproduct" method="post">
            @csrf
            <div class="flex space-x-3 p-5 w-full justify-items-center items-center">
                <div class="mb-6 w-full">
                    <label for="product_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product
