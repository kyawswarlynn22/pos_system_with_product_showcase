...
class Product extends Model implements Auditable
{
    ...
    protected $fillable = ['product_name','p_code', 'categories_id', 'sub_categories_id ', 'p_one',
        'p_two', 'p_three', 'p_four' ,'price', 'quantity', 'description'];

    public function productAllData()
    {
        return $product = Product::select('products.id','categories.c_name','sub_categories.sub_c_name','product_name','p_code', 'p_one',
