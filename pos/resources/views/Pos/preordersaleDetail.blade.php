...
@section('body')
    ...
    <div class=" mt-5 flex  flex-col justify-end items-end">
        <div class="flex mt-5 space-x-3  ">
            ...
            <span class=" font-semibold text-lg">{{ $CashDetails->discount }}</span>
        </div>
        <div class="flex mt-5 space-x-3 ">
            <span class=" font-semibold text-lg">Grand Total : </span>
            <span class=" font-semibold text-lg">{{ $CashDetails->grand_total }}</span>
        </div>

    </div>
    <div class=" flex justify-end space-x-1 pt-5">
        <button class=" bg-yellow-400 text-white rounded-lg font-medium px-5 py-2">Contiune to Shopping</button>
