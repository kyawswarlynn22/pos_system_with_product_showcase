...
@section('body')
    ...
    <div class="mt-3 rounded-lg shadow-lg p-5">
        ...
        <form action="/expense/{{ $ExpenseDetail->id }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="flex w-full justify-around items-center space-x-3 p-5">
                <div class="mb-6 w-full">
                    ...
                    <select name="category_id" id="category_id"
                        ...
                        @forelse ($expeseCategory as $item)
                            <option value="{{ $item->id }}" @if ($item->id == $ExpenseDetail->expense_categories_id) selected @endif>
                ...
                <div class="mb-6 w-full">
                    ...
                    <input type="date" name="date" id="date" value="{{ $ExpenseDetail->date }}"
                        class="bg-gray-50 border w-full border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Description" required>
                </div>
                <div class="mb-6 w-full">
                    ...
                    <input type="number" name="amount" id="amount" value="{{ $ExpenseDetail->amount }}"
                        class="bg-gray-50 border w-full border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div
                ...
                <label for="expenset">
                    <img class="h-52" src="{{ $ExpenseDetail->photo }}" id="expensephotot" alt="">
                </label>
