    ...
    <div class="mt-3 rounded-lg shadow-lg p-5">
        ...
        <div class=" mt-5 flex  flex-col justify-end items-end">
            <div class="flex mt-5 space-x-3  ">
                ...
                <span class=" font-semibold text-lg">{{ $DepositSaleDetail->discount }}</span>
            </div>
            <div class="flex mt-5 space-x-3 ">
                <span class=" font-semibold text-lg">Grand Total : </span>
                <span class=" font-semibold text-lg">{{ $DepositSaleDetail->grand_total }}</span>
            </div>
            <div class="flex mt-5 space-x-3  ">
                <span class=" font-semibold text-lg">Deposit Paid : </span>
                <span class=" font-semibold text-lg">{{ $DepositSaleDetail->deposit }}</span>
            </div>
            <div class="flex mt-5 space-x-3 ">
                <span class=" font-semibold text-lg">Credit Balance : </span>
                <span class=" font-semibold text-lg">{{ $DepositSaleDetail->credit }}</span>
            </div>
        </div>
