...
@section('body')
   ...
   <a href="/user/create"> <button class=" bg-blue-500 px-5 py-2 text-white rounded-lg float-right mb-5">Add New User</button></a>
        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4 flex justify-center space-x-2 ">
                    ...
                    <a href="/user//edit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
