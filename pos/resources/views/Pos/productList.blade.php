        ...
        <table class="w-full text-sm text-left text-gray-500 rounded-lg dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <th scope="row" class="px-6 text py-4 flex items-center space-x-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    ...
                    <td class=" flex justify-center  space-x-2 ">
                        ...
                        <a href="/product/{{ $product->id }}/edit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
